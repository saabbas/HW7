...
Partial Class ContactUs
    ...
    Protected Sub sendMail_Click(sender As Object, e As EventArgs) Handles sendMail.Click
        ...
        msg.To.Add("sean-abbas@uiowa.edu")  'destination email address
        msg.From = New MailAddress(senderAddress.Text)  'get the address from the textbox
        msg.Subject = "Recipe Email Test"  'set the message subject line
        ...
        confirmSent.Text = "Thank you.  Your message has been sent to Sean Abbas."
