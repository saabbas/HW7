...
<asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="swimmerID" DataSourceID="SqlDataSource1" HorizontalAlign="Center" Width="700px" AllowSorting="True">
    <Columns>
